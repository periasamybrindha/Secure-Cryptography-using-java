...
public class CloudServerFrame extends javax.swing.JFrame {
    ...
    public final void viewUserDetails()
    {
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                String ciphertext=FileRead(fileLocation);                
                
                DefaultTableModel dm=(DefaultTableModel)jTable3.getModel();
                Vector v=new Vector();
                v.add(don.trim());                    
                v.add(fn.trim());
                v.add(ciphertext.trim());                
                dm.addRow(v);
            }
        }
        catch(Exception e)
    ...
    private void initComponents() {
        ...
        jTable3.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "DataOwnerName", "FileName", "Ciphertext"
            }
        ));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        demo1 = new BarChartDemo1("Upload File Size");
        demo1.pack();
    ...
    private void jTable3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable3MouseClicked
        ...
        String content=jTable3.getValueAt(row,2).toString().trim();
        
        ViewFile vf=new ViewFile();
        vf.setTitle("View File");
        vf.setVisible(true);
        vf.setResizable(false);
        vf.jTextArea1.setText(content.trim());
    ...
    private CategoryDataset createDataset() {
        ...
        for(int i=0;i<jTable3.getRowCount();i++)
        {
            ...
            String blockContent=jTable3.getValueAt(i,2).toString().trim();
            
            dataset.addValue((double)blockContent.length(),filename.trim(),filename.trim()); 
        }                
    ...
    private JFreeChart createChart(final CategoryDataset dataset) {
        ...
        final JFreeChart chart = ChartFactory.createBarChart(
            "Uploaded File Size",         // chart title
